...
var ServerService = {
    ...
    setupGetCounterListener: function(alljoynBus, responseServerTextarea) {
        alljoynBus.addListenerForReply([1, 0, 0, 1], '', function(msgForReply) {
            console.log('getCounter method was called!');

            responseServerTextarea.value = responseServerTextarea.value + "\n- getCounter Method was called, send count value: " + count;

            msgForReply.replySuccess('i', [count]);
        });
    }
};